...
private:
	...
	void BestScore_Result(int simu, int gene); // 最良スコアの保存
	void Adjust_blackcell(int i, int r1, int r2, int c1, int c2, int loop);
	void EvaluationFunction_LineCol(int i); // 評価関数の算出
	void EvaluationFunction_Objective(int i); // 目的関数の算出
